# Generated by Django 4.1.5 on 2023-04-24 19:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('digital_identity', models.CharField(blank=True, max_length=100, unique=True, verbose_name='ID')),
                ...
                ('application_status', models.CharField(choices=[('Frontdesk', 'Frontdesk'), ('No Application', 'No Application'), ('Regular Application', 'Regular Application'), ('Southeast', 'Southeast'), ('Human Resources', 'Human Resources'), ('Pending', 'Pending'), ('Undefined', 'Undefined')], default='Undefined', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_workers_compensation', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('workers_compensation_details', models.CharField(blank=True, max_length=50, null=True)),
                ('received_surgery_for_fracture', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('fracture_details', models.CharField(blank=True, max_length=50, null=True)),
                ('physical_disability_evaluation', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('physical_disability_details', models.CharField(blank=True, max_length=100, null=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='management.officelocation'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_job', models.CharField(choices=[('Full Time', 'Full Time'), ('Part Time', 'Part Time'), ('Seasonal', 'Seasonal')], max_length=50)),
                ...
                ('worked_for_this_company_before', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('start_date_worked_for_this_company', models.DateField(blank=True, null=True)),
                ('end_date_worked_for_this_company', models.DateField(blank=True, null=True)),
                ('has_been_convicted_of_a_felony', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('felony_details', models.CharField(blank=True, max_length=50, null=True)),
                ('can_background_check', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('test_controlled_substances', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ...
                ('service_branch', models.CharField(blank=True, max_length=50, null=True)),
                ('start_period_service', models.DateField(blank=True, null=True)),
                ('end_period_service', models.DateField(blank=True, null=True)),
                ('duties_training_service', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.city')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_address_employee', to='management.employee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='management.employee')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('office_location', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='management.officelocation')),
